...
char phone_number_checker(char phone_number[40]) { // this function adds 0 to the beginning of the phone number
    int i;
...
int residential_property(int rent_or_sell) {
    char address[100], building_lifespan[10], building_meterage[10], building_municipal_area[3];
    char floor[3], base_meterage[10], owner_phone_number[11], rooms[3], type[20];
    int i, c, count1;
    FILE *fp;
    ...
    while (1) {
        ...
        phone_number_checker(owner_phone_number);
    ...
    if (rent_or_sell == 2) {
        ...
        struct residential_property {
            ...
            char building_meterage[12];
            char building_municipal_area[4];
            char floor[5];
            char base_meterage[12];
...
int office_property(int rent_or_sell) {
    char address[100], building_lifespan[3], building_meterage[11], building_municipal_area[3];
    char floor[3], base_meterage[11], owner_phone_number[11], rooms[3], type[20];
    int i, c, count1;
    FILE *fp;
...
int land_property(int rent_or_sell) {
    char address[100], type[20], land_meterage[12], owner_phone_number[14], land_municipal_area[4];
    int i, c, count1;
    FILE *fp;
