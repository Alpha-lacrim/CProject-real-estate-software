...
void sign_up() {
    char username[50], name[20], last_name[40], email[100], phone_number[12], role[10], citizen_id[12];
...
void main() {
    ...
    while (1) {
        ...
        if ((strcmp(choice, "1") == 0)|| (strcmp(strlwr(choice), "sign up") == 0)) {
            ...
            //*- sign in *-
            char input_username[40], input_pw2[50], role2[20], ch;
            ...
            while (1) {
                ...
                while (feof(fp) == 0) {
                    ...
                    if (strcmp(temp->pw, input_pw2) == 0 && strcmp(temp->username, input_username) == 0) {
                        loop_checker += 1;
                        strcpy(role2, temp->role);
